...
wp_enqueue_script (
    "braintree-js",
    "/wp-content/themes/dmind/bower_components/braintree-web/dist/braintree.js?v=1.0",
    array("jquery-niroga"), false, true);

$user_id = username_exists( "mbs" );

require 'vendor/braintree/braintree_php/lib/Braintree.php';
require "braintree-config.php";
